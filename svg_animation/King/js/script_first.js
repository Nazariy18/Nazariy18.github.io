...
//People
var showPeople = s.select("#rectPeople"),
    showHead = s.select("#yellow_pep"),
    showPeopleMessage = s.select("#pep_message"),
    showPepLines = s.select("#pep_lines");
...
showFlower.attr({'y' : 755});
showKing.attr({'y' : 492});
showMB.attr({'y' : 783, 'x': 249});
showMCR.attr({'y' : 785});
showHorse.attr({'y' : 783});
showHorseFill.attr({'y' : 783});
showMF.attr({'y' : 610});
showFillMF.attr({'y' : 610});
showArrow.attr({'y' : 150});
showLamp.attr({'y' : 684});
showStrokeHorn.attr({'x' : -116.5});
showPeople.attr({'y' : 705});
...
showHead.attr({'opacity' : 0});
showPeopleMessage.attr({'opacity' : 0});
showPepLines.attr({'opacity' : 0});
...
function fTreeF() {
    showFlower.stop().animate({'y' : 704.9}, 1500, mina.linear); }
//----------------------------land
function fLand() {
    var j=0; 
    function fshowLand () { 
...
function fKing() {
    showKing.stop().animate({'y' : 642.6}, 2000, mina.linear);
    } 

function fMonitorBack() {
    showMB.stop().animate({'y' : 713.5, 'x': 109.9}, 1000, mina.linear); 
...
function fMicroscope() {
    showMCR.stop().animate({'y' : 704.4}, 2000, mina.linear); 
}

function fHorse() {
    showHorse.stop().animate({'y' : 679.7}, 2000, mina.linear);
    showHorseFill.stop().animate({'y' : 679.8}, 2000, mina.linear);
}

function fMonitorFront() {
    showMF.stop().animate({'y' : 700.6}, 2000, mina.linear);
    showFillMF.stop().animate({'y' : 700.6}, 2000, mina.linear);
    
    var dataBarMF = [14.1, 18.3, 26.8, 29.1, 33];
    var dataBarMFy = [739.3, 735.1, 726.6, 724.3, 720.4];
    var i6=0; 
    function fshowBarMF () { 
...
function fLetter() {
    ...
    var dataBarLettery = [732.5, 728.4, 722.9, 720, 715.9, 718, 713.9];
    var i9=0; 
...
function fLamp() {
    ...
    showLamp.stop().animate({'y' : 657.8}, 1000, mina.linear); 
...
function fHorn() {
    showStrokeHorn.stop().animate({'x' : -66.5}, 1200, mina.linear);
...
function fPeople() {
    showPeople.stop().animate({'y': 658.1}, 1500, mina.linear);
}

function fPeopleOther() {
    showPeopleMessage.stop().animate({'opacity': 1}, 500, mina.linear); 
    showPepLines.stop().animate({'opacity': 1}, 1500, mina.linear); 
    showHead.stop().animate({'opacity': 1}, 2000, mina.linear); 
}
...
setTimeout('fPeople()', 2000);
setTimeout('fPeopleOther()', 4000);
...
function moveBar1() {
    ...
    var dataBarLettery1 = [732.5, 728.4, 722.9, 720, 715.9, 718, 713.9];
    var dataBarMF1 = [14.1, 18.3, 26.8, 29.1, 33];
    var dataBarMFy1 = [739.3, 735.1, 726.6, 724.3, 720.4];
